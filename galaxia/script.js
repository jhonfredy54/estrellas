...
const starSphere = new THREE.Points(starGeometry, starMaterial);
...
const frases = [
"Me encantas ✨", "Qué peligro tienes 😉", "Mi distracción favorita ⚡",
"Me haces sonreír 😊", "Qué buena vibra 🍃", "Mi persona favorita 💫",
"Me caes muy bien 🧸", "Eres un sol ☀️",
"Qué suerte coincidir 🌊", "Haces falta aquí ☁️",
"Lo más lindo de mi día 🌻", "Tú y tus cosas 🙊"
];
...
const audio = new Audio("Solo.Tu.mp3");
audio.loop = true;
audio.volume = 0;
